		...
		<form method="post">
			<div class="col-md-3">
				<div class="panel panel-primary">
					<div class="panel-heading">Transaksi Baru</div>
			...
			<div class="col-md-9">
				<div class="panel panel-primary" >
					<div class="panel-heading" style="height:40px;">
						<h4 class="panel-title pull-left">TOKO MOROSENENG </h4>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php  
									...
									@$no = 0;
									if ($b == "") {
										echo "<tr><td colspan='7' align='center'><b>Silahkan Tambahkan Barang</b></td></tr>";
									}else{
										foreach ($b as $data) {
											$no++;
									?>		
