		...
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="input"><div class="glyphicon glyphicon-th-list"></div>&nbsp;&nbsp;MENU&nbsp; <span class="caret"></span></a>
					<ul class="dropdown-menu" aria-labelledby="input">
						<li>
							<a href="?menu=daftarjenis">Tambah Jenis Barang</a>
						</li>
						<li>
							<a href="?menu=daftarbarang">Tambah Barang</a>
						</li>
						<li>
							<a href="?menu=daftarsupplier">Tambah Supplier</a>
						</li>
						<li>
							<a href="?menu=daftaruser">Tambah User</a>
						</li>
                        <li><div class="divider"></div></li>
						<li>
							<a href="?menu=pembelianbarang">Tambah Pembelian Barang</a>
						</li>
		...
		<!--	<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					...
					<ul class="dropdown-menu" aria-labeldby="laporan">
						...
						<li class="divider"></li>
						<li>
							<a href="?menu=lapbelibarang">Daftar Pembelian</a>
						</li>
						<li>
							<a href="?menu=laptransaksiharian">Daftar Transaksi</a>
						</li>			

						<li>
							<a href="?menu=laptransaksibulanan">Daftar Transaksi &nbsp;(Bulanan)</a>
						</li>
						<li>
	...
	<script>
		 $(function () {
		   ...
		   $("#thargapokok").keyup(function(){
                ...
                $("#tppn").val(0);
                if(cekppn == "y") $("#tppn").val(hargapokok * 0.11);
