							 ...
							 <td>
                                <div class="form-group">
                                	<div class="input-group">
	                                    ...
	                                    <input type="text" name="tppn" id="tppn" value="<?php echo @$edit['ppn']; ?>" class="form-control" placeholder="PPN (11%)"  required maxlength="11" readonly autocomplete="off" tabindex="1">
	                                	 <div class="input-group-addon">
	                                        <input type="checkbox" name="cekppn" id="cekppn" value="y" checked="checked" tabindex="0">11%
	                                    </div>
	                                </div>
                                </div>	
                            </td>
