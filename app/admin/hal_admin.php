	...
	<div class="container">
		<div class="col-md-12">
			<div class="alert alert-dismissible alert-success">
			  ...
			  <strong><b><?php echo $_SESSION['nama']; ?></b></strong>
			  <br>
				Selamat Datang Di Tampilan Dashboard, Jika Anda Ingin keluar,klik <a href="?logout" onclick="return confirm('Apakah Anda yakin akan keluar dari akun ?');"><span id="blue"><b>Disini</b></span></a>
			</div>
-->
		</div>
	</div>
