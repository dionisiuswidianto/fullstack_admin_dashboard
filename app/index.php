	...
	<div class="container">
		...
		<div class="col-md-6">
			<div class="panel panel-primary" style="margin-top:120px;">
				<div class="panel-primary" style="padding:20px;">
					<div class="col-md-1"></div>
					<div style="font-size:200%;"><strong>KASIR.IN</strong></S> </div>
					<div class="col-md-1"></div>
				...
				<div class="panel-footer" align="center">
						Dionisius Putra Widianto - 00000030769
				</div>
			</div>
		</div>
