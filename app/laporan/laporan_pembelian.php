		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form method="post">
					...
					<div class="col-md-4 pull-right" style="margin-right:-250px;">
						<div class="input-group">
							<div class="input-group-btn">
								<a href="../laporan/cetak_pembelian.php?bln=<?php echo $bulanini; ?>&thn=<?php echo $tahunini; ?>" target="_blank" class="btn btn-warning"><div class="glyphicon glyphicon-print"></div>&nbsp;Print</a>
								<a href="../laporan/cetak_pdf.php?menu=pembelian&bln=<?php echo $bulanini; ?>&thn=<?php echo $tahunini; ?>" target="_blank" class="btn btn-danger"><div class="glyphicon glyphicon-save-file"></div>&nbsp;Simpan PDF</a>
					...
					<table class="table table-bordered table-hover table-striped">
						...
						<tbody>
							<?php  
								...
								@$no = 0;
								if ($sql =="") {
									echo "<tr><td align='center' colspan='10'>Tidak Ada Data</td></tr>";
								}else{
									foreach ($sql as $data) {
										$no++;
							?>
