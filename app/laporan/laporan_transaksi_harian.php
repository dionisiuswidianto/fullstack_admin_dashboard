	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-heading" style="height:40px;">
				<?php  
					if (isset($_POST['blihat'])) { ?>						
						<h3 class="panel-title pull-left">Daftar Transaksi - Tanggal &nbsp;<?php echo @$tgl_awal." &nbsp;Sampai&nbsp;&nbsp;".@$tgl_akhir ; ?></h3>
				<?php }else{ ?>
						<h3 class="panel-title pull-left">Daftar Transaksi - Tanggal &nbsp;<?php echo @$tanggal?></h3>
				<?php } ?>
			...
			<div class="panel-body">
				<form method="post">
					...
					<div class="col-md-4 pull-right" style="margin-right:-149px;">
						<div class="input-group">
							<div class="input-group-btn">
								<a href="../laporan/cetak_transaksi_harian.php?tgl=<?php echo $tgl ?>&tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>" target="_blank" class="btn btn-warning"><div class="glyphicon glyphicon-print"></div>&nbsp;Print</a>
								<a href="../laporan/cetak_pdf.php?menu=transaksi_harian&tgl=<?php echo $tgl ?>&tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>" target="_blank" class="btn btn-danger"><div class="glyphicon glyphicon-save-file"></div>&nbsp;Simpan PDF</a>
					...
					<table class="table table-bordered table-hover table-striped">
						<thead id="pri">
							...
							<th width="15%"><center>Nama Kasir</center></th>
