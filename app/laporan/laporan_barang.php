					...
					<div class="col-md-4 pull-right" style="margin-right:-154px;">
						<div class="input-group">
							<div class="input-group-btn">
								<a href="../laporan/cetak_barang.php" target="_blank" class="btn btn-warning"><div class="glyphicon glyphicon-print"></div>&nbsp;Print</a>
								<a href="../laporan/cetak_pdf.php?menu=barang" target="_blank" class="btn btn-danger"><div class="glyphicon glyphicon-save-file"></div>&nbsp;Simpan PDF</a>
							</div>
						</div>
					</div>			
				</div>
