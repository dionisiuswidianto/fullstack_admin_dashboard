		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0">
			<thead>
				...
				<tr>
					...
					<th width="23%" style="border:1px solid black">Nama Supplier</th>
					<th  style="border:1px solid black">Alamat Supplier</th>
					<th width="18%" style="border:1px solid black">No. Telepon</th>
				</tr>
			</thead>
			<tbody>
				<?php  
