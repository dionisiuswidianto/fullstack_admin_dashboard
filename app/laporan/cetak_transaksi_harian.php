...
<body onload="window.print();" style="font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma,  sans-serif;width:21cm;">
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0" >
			<thead>
				<tr>
				 	<td colspan="5">
				 		<h1 style="margin:0">TOKO MOROSENENG</h1>
				 		<h4 style="margin:0;margin-top:4px;">Jl. Gamblok Kec. Ambarawa</h4>
				 	</td>
				</tr>
				...
				<tr>
				 	<td colspan="7" align="center">
						...
						<?php  
							if (empty($_GET['tgl_awal'])||empty($_GET['tgl_awal'])) {
						?>
							<h3 align="center">Daftar Transaksi - Tanggal <?php echo $a." ".$bln." ".$c; ?></h3>
						<?php }else{ ?>
							<h3 align="center">Daftar Transaksi - Dari Tanggal <?php echo $aa." ".$bln1." ".$ac; ?> &nbsp;-&nbsp;<?php echo $ba." ".$bln2." ".$bc; ?></h3>
						<?php } ?>
				...
				<tr style="border:1px solid black;">
					...
					<th width="15%"  style="border:1px solid black">Nama Kasir</th>
			...
			<tbody  style="border:1px solid black;">
				...
				<?php } } 
					...
					?>
						<tr>
							<td colspan="6" align="right" style="border:1px solid black;padding-right:10px"><b>Pendapatan Tanggal <?php echo $a." ".$bln." ".$c; ?> : </b></td>
