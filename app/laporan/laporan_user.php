	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-heading" style="height:40px;">
				<h3 class="panel-title pull-left"></h3>Daftar User</h3>
			...
			<div class="panel-body">
				...
				<div class="col-md-12" style="margin-bottom:10px;">
					<div class="col-md-4 pull-right" style="margin-right:-154px;">
						<div class="input-group">
							<div class="input-group-btn">
								<a href="../laporan/cetak_user.php" target="_blank" class="btn btn-warning"><div class="glyphicon glyphicon-print"></div>&nbsp;Print</a>
								<a href="../laporan/cetak_pdf.php?menu=user" target="_blank" class="btn btn-danger"><div class="glyphicon glyphicon-save-file"></div>&nbsp;Simpan PDF</a>
